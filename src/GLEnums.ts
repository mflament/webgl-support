...
export function glConstantName(gl: WebGL2RenderingContext, constant: GLenum): string {
    return Object.keys(gl).find(k => gl[k as keyof WebGL2RenderingContext] === constant) || constant.toString();
}